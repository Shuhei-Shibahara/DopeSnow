        ...
        <div className="drop-down-container">
          <div className='drop-down'>
            <ol>
              <li>
                <div className="div_individual_category">
                  <Link to="/products/W/Womens-Snowboard-Jackets" className="category_link">
                    <div className="image_div">
                      <img
                        className="category_image"
                        alt="Jackets"
                        src="https://ridestore.imgix.net/catalog/product//E/8/E8471_200.jpg?fit=crop&w=38&q=60&dpr=2&usm=15&fm=avif&crop=entropy&h=38" 
                      />
                    </div>
                    <span className="category_name">Jackets</span>
                  </Link>
              ...
              <li>
                <div className="div_individual_category">
                  <Link to="/products/W/Womens-Snowboard-Pants" className="category_link">
                    <div className="image_div">
                      <img
                        className="category_image"
                        alt="Pants"
                        src="https://ridestore.imgix.net/catalog/product///2/0/2020-12-10-omfoto_dope_byxor-519.jpg?fit=crop&w=38&q=60&dpr=2&usm=15&fm=avif&crop=entropy&h=38"
                      />
                    </div>
                    <span className="category_name">Pants</span>
                  </Link>
                  ...
                  <Link to="/products/w/Womens-Hoddies" className="category_link">
                    <div className="image_div">
                      <img
                        className="category_image"
                        alt="Hoodie"
                        src="https://ridestore.imgix.net/catalog/product/E/9/E9927_1.jpg?fit=crop&w=38&q=60&dpr=2&usm=15&fm=avif&crop=entropy&h=38"
                      />
                    </div>
                    <span className="category_name">Hoodies</span>
                  </Link>
              ...
              <li>
                <div className="div_individual_category">
                  <Link to="/products/W/Womens-T-shirts" className="category_link">
                    <div className="image_div">
                      <img
                        className="category_image"
                        alt="Tshirt"
                        src="https://ridestore.imgix.net/catalog/product///e/7/e7517_1.jpg?fit=crop&w=38&q=60&dpr=2&usm=15&fm=avif&crop=entropy&h=38"
                      />
                    </div>
                    <span className="category_name">T-shirts</span>
                  </Link>
